...
LAYOUTS = {
    ...
    "one_chart": LayoutSpec(
        ...
        slots={
            ...
            "chart_1_title": {"type": "text",     "content_type": "chart_title",
    
                              "style_key": "chart_title", "source": "chart_1", "x": 0.5, "y": 1.1, "w": 12.5, "h": 0.5},
        },
    ),
    # =========================================================
    # TWO CHART
    ...
    "two_chart": LayoutSpec(
        ...
        slots={
            ...
            "chart_1_title": {"type": "text",     "content_type": "chart_title",
                              ...
                              "style_key": "chart_title", "source": "chart_1", "x": 0.5, "y": 1.1, "w": 6.25, "h": 0.5},
            # Chart 2
            "chart_2": {"type": "chart", "x": 6.75, "y": 1.6, "w": 6.25, "h": 5.25},
            "chart_2_title": {"type": "text",     "content_type": "chart_title",
    
                              "style_key": "chart_title", "source": "chart_2", "x": 6.75, "y": 1.1, "w": 6.25, "h": 0.5},
        },
    ),
    # =========================================================
    # THREE CHART
    ...
    "three_chart": LayoutSpec(
        ...
        slots={
            ...
            "chart_1_title": {"type": "text",     "content_type": "chart_title",
                              ...
                              "style_key": "chart_title", "source": "chart_1", "x": 0.5, "y": 1.1, "w": 4.17, "h": 0.5},
            # Chart 2
            "chart_2": {"type": "chart", "x": 4.67, "y": 1.6, "w": 4.17, "h": 5.25},
            "chart_2_title": {"type": "text",     "content_type": "chart_title",
    
                              "style_key": "chart_title", "source": "chart_2", "x": 4.67, "y": 1.1, "w": 4.17, "h": 0.5},
            # Chart 3
            "chart_3": {"type": "chart", "x": 8.84, "y": 1.6, "w": 4.17, "h": 5.25},
            "chart_3_title": {"type": "text",     "content_type": "chart_title",
    
                              "style_key": "chart_title", "source": "chart_3", "x": 8.84, "y": 1.1, "w": 4.17, "h": 0.5},
        },
    ),
}
